...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Slovní hodnocení pro známky " + Arrays.toString(znamky) + ": " + vp.prospech(znamky));
    ...
    System.out.println(
        "comp(\"apple\", \"banana\") = " + ZpracovaniMy.comp("apple", "banana")); // -1

    // === 3) Test interval (otevřený interval) ===
    System.out.println("\nTestování intervalu (otevřený interval):");
    System.out.println("interval(1, 5, 3) = " + Zpracovanii.interval(1, 5, 3)); // true
    System.out.println("interval(1, 5, 1) = " + Zpracovanii.interval(1, 5, 1)); // false
    System.out.println("interval(1, 5, 5) = " + Zpracovanii.interval(1, 5, 5)); // false

    // === 4) Generování vzorků sestupně ===
    System.out.println("\nGenerování vzorků:");
    double[] vzorky = Zpracovanii.vzorkySestupně(2.0, 10.0, 2.0); // od 10.0 do 2.0 krokem 2.0
